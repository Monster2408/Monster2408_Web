<div class="w-50 text-center">
    ...
    <p class="text-left" lang="ja">元々はコマンドでミニゲーム企画を開催していましたが限界を感じてSkript(Bukkit Plugin)を使い始めました。そこから5つほど企画を作り，バグなどの原因でプラグインの勉強を始めました。</p>
    <p class="text-left" lang="en">Originally, I used to organize mini-games with commands, but I started using Skript, Skript is Bukkit Plugin, because I felt its limitations. From there, I created about 5 projects and started learning about bukkit plugin due to bugs and such.</p>
    <p class="text-left" lang="ja">本格的な開発者歴自体は5年ぐらいです。Skript以外ではJava,HTML,CSS,JavaScript,PHP,Python,MySQL,Cなどを使てシステム設計をしています。</p>
